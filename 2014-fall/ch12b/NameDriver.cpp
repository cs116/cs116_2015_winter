...
int main () 
{
  ...
  {
    case BEFORE: cout << "His name comes before her name" << endl;
	             break;
	case SAME:   cout << "His name and her name are the same" << endl;
	             break;
	case AFTER:  cout << "His name comes after her name" << endl;
  }
  return 0;
}
