...
// location.
//
// 09/22/2014: George P Corser 
// Commented out awkward messages (see labels "gpc0922")
// 
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
int main()
{
   ...
   /* ----- gpc0922: commented out stuff below...
   ...
   getChar(input);
   -------------------------------------------- */
   cout << "Results will print to SE-135" << endl;
   input = '2'; // gpc0922: added this line to default to SE-135
   menuTest = 7;
   selection = 0;
   chkInput(input, selection, menuTest);
